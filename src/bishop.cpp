...
void Bishop::covers(vector<Position> &list_covers, Board &board, Position &pos) {

  // Bishop covers four directions
...
void  Bishop::moves(std::vector<Board> &list_board_moves, Board &board, Position &pos) { 
