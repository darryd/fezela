...
void Rook::covers(vector<Position> &list_covers, Board &board, Position &pos) {

  // Rook covers four directions
...
void Rook::moves(std::vector<Board> &list_board_moves, Board &board, Position &pos){
